...
func TestTheFragmentPromptIsAnOutline(t *testing.T) {
	...
	for _, must := range []string{
		...
		"'shall', 'must', and 'required' are",
		"never weaken them to should/could",
		"Before ADDING",
		"Never both change an existing section and add another section",
		"distinct, independently testable behavior",
		"Never copy an Assumption or other field from a different section",
		"**Delete:** yes",
