...
export const KNOWN_EVENT_TYPES = [
  ...
  "reference_digested",
  "sections_folded",
  "sectioned_checkpoint",
  "sectioned_checkpoint_restored",
  "sectioned_pass_restarted",
  "message",
  "proposal",
  "verdict",
  "candidate",
  ...
  "proposal_composition_mechanical_blocked",
  "proposal_composition_review_blocked",
  "proposal_identity_blocked",
  "proposal_structure_blocked",
  "proposal_structure_notices",
  "pause_requested",
  "pause_deferred",
  "dedupe",
  "superseded_tasks_consumed",
  "no_gate",
  "toolchain_missing",
  "draft_carried",
  "contestant_failed",
